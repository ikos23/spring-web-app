...
/* Mentorship program */
CREATE TABLE MTProgram(id INT PRIMARY KEY, name VARCHAR(30) NOT NULL, office_location VARCHAR(50) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL);
